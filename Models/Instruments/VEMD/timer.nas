...
var p = "/sim/model/ec130/flight-duration/";
			...
			var trig = props.globals.getNode("controls/engines/engine/startselector").getValue() or 0;
...
init:func{
var last_fltn = props.globals.getNode("/sim/model/ec130/flightnumber").getValue() or 0;
#var trigger = props.globals.getNode("controls/engines/engine/startselector").getValue() or 0;

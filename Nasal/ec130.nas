...
var engines = {
  ...
  adjust_power: func(delta, mode = 0) {
    if (!delta) {
      ...
      gui.popupTip(sprintf("Twist Grip %d%%", 100 * max(p[0], p[1])));
      # mhab
...
autostart = func () {
  ...
  if ( getprop("/sim/model/ec130/flightnumber") >= getprop("/sim/model/ec130/minflights") ) {
    if ( getprop("/controls/electric/external-power")) {
      ...
      settimer(func { setprop("/controls/lighting/dome-light", 1);         },5.0);
      settimer(func { setprop("/controls/lighting/instrument-lights", 1);  },5.5);
      settimer(func { setprop("/controls/lighting/instrument-lights2", 1); },6.0);
...
autoshutdown = func () {
  ...
  var rotor_slow_enough_to_brake = func () {
    ...
    settimer(func { setprop("/controls/lighting/instrument-lights2", 0);           },6.5);
    settimer(func { setprop("/controls/lighting/instrument-lights", 0);            },7.0);
    settimer(func { setprop("/controls/lighting/dome-light", 0);                   },7.5);
    settimer(func { setprop("/controls/electric/directbat-switch", 0);             },8.0);
    settimer(func { setprop("/controls/electric/engine/generator", 0);             },8.5);

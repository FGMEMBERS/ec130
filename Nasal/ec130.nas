  ...
  adjust_power: func(delta, mode = 0) {
    if (!delta) {
      ...
      if ( getprop("/controls/electric/external-power") ) {
        if (delta > 0) {
          settimer(func{ gui.popupTip("Disconnect external power supply before Take-Off !!!",3); },1.5);
        }
      }
    }
  },
...
toggle_powersupply = func () {
  ...
  if ( p or getprop("/rotors/main/rpm") < 300 ) {
    ...
    gui.popupTip("External power cannot be connected when Rotor RPM 300+ !!!",4);
  }
...
autostart = func () {
  ...
  if ( getprop("/sim/model/ec130/flightnumber") >= getprop("/sim/model/ec130/minflights") ) {
    if ( getprop("/controls/electric/external-power")) {
      ...
      # screen.log.write("Automatic startup routine ... please wait ...", 0, 1, 0);
      # release rotorbreak
      ...
      setprop("/controls/electric/gyrocompass", 1);
      setprop("/instrumentation/attitude-indicator/serviceable", 1);
      setprop("/controls/anti-ice/pitot-heat", 1);
      setprop("/controls/lighting/beacon", 1);
      setprop("/controls/lighting/nav-lights", 1);
      setprop("/controls/lighting/dome-light", 1);
      setprop("/controls/lighting/instrument-lights", 1);
      setprop("/controls/lighting/instruments-lights2", 1);
#      setprop("/controls/electric/horn", 1);
      ...
      gui.popupTip("External power supply (Alt-p) is necessary for startup !!!",3);
    }
  }
}
